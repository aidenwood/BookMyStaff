...
function Calendar({
  ...
  // Create modifiers for available/unavailable dates
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary-600 text-slate-50 hover:bg-primary-600 hover:text-slate-50 focus:bg-primary-600 focus:text-slate-50",
